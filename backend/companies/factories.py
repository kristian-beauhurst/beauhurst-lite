...
class UserFactory(factory.django.DjangoModelFactory):
    ...
    email = email = factory.LazyAttribute(lambda user: "{}@example.com".format(user.username))
...
class EmployeeFactory(factory.django.DjangoModelFactory):
    ...
    gender = factory.Faker("random_element", elements=[gender[0] for gender in Employee.GENDERS])
    email = factory.LazyAttribute(lambda employee: "{}@site.com".format(slugify(employee.name)))
